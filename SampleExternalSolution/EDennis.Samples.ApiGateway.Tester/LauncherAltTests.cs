...
using L = EDennis.Samples.ApiGateway.LauncherAlt;


namespace EDennis.Samples.ApiGateway.Tester {
    public class LauncherAltTests : UnitTestBase<G.Program,L.Program> {

        public LauncherAltTests(LauncherFixture<G.Program,L.Program> fixture,
